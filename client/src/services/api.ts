...
export const ventasApi = {
  ...
  getTransacciones: (params?: any) => api.get('/ventas/transacciones', { params }),
};
...
export const ventaRCApi = {
  ...
  getPorProductoFormulado: (params?: any) => api.get('/venta-rc/por-producto-formulado', { params }),
  getPorNombreProducto: (params?: any) => api.get('/venta-rc/por-nombre-producto', { params }),
